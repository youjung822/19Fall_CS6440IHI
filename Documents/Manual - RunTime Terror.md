...
Frontend Application URL: `curl -I https://apps.hdap.gatech.edu/newfoodplanner2frontend/`
Response:
```
HTTP/1.1 200 OK
...
Backend Application URL: `curl https://apps.hdap.gatech.edu/newfoodplanner2backend/`
Response:
```
...
#### 8.2. Local Servers
Frontend Application URL: `curl -I http://localhost:3000/`
Response:
```
HTTP/1.1 200 OK
Date: Sun, 24 Nov 2019 20:54:07 GMT
